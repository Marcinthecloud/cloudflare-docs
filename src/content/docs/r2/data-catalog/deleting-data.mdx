...
npx wrangler r2 bucket catalog compaction enable my-bucket \
	--target-size 256
```
More information can be found in the [table maintenance documentation](/r2/data-catalog/table-maintenance/) and [manage catalogs documentation](/r2/data-catalog/manage-catalogs/).
