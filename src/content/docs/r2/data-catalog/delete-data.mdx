...
:::note
You can use R2 Data Catalog to automate [rewriting data files](/r2/data-catalog/table-maintenance).
:::
...
### Delete data using PySpark

The following are basic examples using PySpark. You can perform similar operations using other Iceberg-compatible engines.

To configure PySpark, refer to the [PySpark R2 Data Catalog example](/r2/data-catalog/config-examples/spark-python/) or the official [PySpark documentation](https://spark.apache.org/docs/latest/api/python/getting_started/index.html).
