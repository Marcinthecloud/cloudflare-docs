...
For questions about **pricing** or **usage limits**, see the dedicated FAQs on the [Pricing page](/browser-rendering/platform/pricing/#faq) and the [Limits page](/browser-rendering/platform/limits/#faq).
