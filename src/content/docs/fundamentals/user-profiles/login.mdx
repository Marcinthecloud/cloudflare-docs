...
If you use Apple or Google to sign in, your user profile will not have a password associated with it at first. Some dashboard operations will require setting dashboard password. To set a password, visit [Forgot Password](https://dash.cloudflare.com/forgot-password) in the Cloudflare dashboard.
:::
